...
<div class="container">
    <div class="video">
        <video id="myVideo" ><source src="materials/first_chart.mp4"></video>
    </div>
    <div class='ans'>
        <div class="question-block">
            ...
            <form class="formContainer" action='src/actions/test3chart1act.php' method="post" enctype="multipart/form-data">
...
<script src='/test3script/chart1.js'></script>
