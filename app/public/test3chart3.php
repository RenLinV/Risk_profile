...
<div class="container">
    <div class="video">
        <video id="myVideo" ><source src="materials/third_chart.mov"></video>
    </div>
    <div class='ans'>
        <div class="question-block">
            ...
            <form class="formContainer" action='src/actions/test3chart3act.php' method="post" enctype="multipart/form-data">
                ...
                <button class="formsubmitbutton" id='submitButton' type='submit'>Завершить</button><br><br>
            </form>
        </div>
    </div>
</div>
...
<script src='/test3script/chart3.js'></script>
